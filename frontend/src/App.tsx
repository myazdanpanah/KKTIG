...
import { FinanceShell, FinanceDashboard, PayersPage, InvoicesPage, PaymentsPage, DebtsCreditsPage, ApprovalsPage, ItemTypesPage, FinanceSettingsPage, TemplateEditorPage } from './pages/finance'
